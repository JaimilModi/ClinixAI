    ...
    <div className="min-h-screen w-full bg-pink-50 p-6 lg:p-10 text-slate-700 pt-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-6 text-sm font-medium text-gray-700">Upload PDF</p>
          <input
            onChange={(e) => setInput(e.target.files[0])}
            type="file"
            accept="application/pdf"
            className="w-full p-3 mt-2 outline-none text-sm rounded-md border border-gray-300 focus:border-pink-500 focus:ring focus:ring-pink-100 text-gray-600"
            required
          />
